...
namespace clickrain\cdnhelper;

use clickrain\cdnhelper\twigextensions\CdnHelperTwigExtension;
 ...
 *
 */
class CdnHelper extends Plugin
{
    // Static Properties
    // =========================================================================
    ...
    public function init()
    {
        ...
        if (Craft::$app->request->getIsSiteRequest()) {
            ...
            Craft::$app->view->registerTwigExtension(new CdnHelperTwigExtension());
        }
